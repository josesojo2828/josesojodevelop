...
interface SingleVlogPostProps {
    onBack: () => void;
}

export default function SingleVlogPost({ onBack }: SingleVlogPostProps) {
    ...
    return !vlogData || !data
        ? <></>
        : <SingleVlog data={data} onBack={onBack} />
}

function SingleVlog({ data, onBack }: { data: Vlog, onBack: () => void }) {
